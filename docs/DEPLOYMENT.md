...
8. Configure Reddit OAuth, Reddit API approval, Resend sender-domain verification, Slack, Google CSE, Sentry, and healthcheck endpoints as applicable.
...
16. Until Dodo is configured, paid-plan links intentionally route to contact. Until Reddit OAuth is configured, direct Reddit posting must remain unavailable.
