    ...
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-text-primary mb-2">Scouto</h1>
          <p className="text-text-secondary">Log in to your account</p>
        </div>

        <div className="glass rounded-[20px] p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_4px_24px_rgba(0,0,0,0.4)]">
          <form action={signInWithGoogleAction} className="mb-6">
            <button 
              type="submit" 
              className="w-full flex items-center justify-center gap-2 bg-white text-black py-3 rounded-xl font-medium transition-transform hover:scale-[1.01] active:scale-[0.98]"
            >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs font-medium text-text-tertiary uppercase tracking-wider">or continue with email</span>
            <div className="h-[1px] flex-1 bg-black/5"></div>
          </div>
