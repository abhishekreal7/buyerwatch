    ...
    <div className="min-h-screen w-full bg-[#FAFAFA] flex flex-col justify-between items-center p-6 sm:p-10 relative selection:bg-black selection:text-white font-sans overflow-hidden">
      ...
      >
        ...
        <div className="bg-white rounded-2xl p-7 sm:p-8 border border-black/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.03),0_12px_32px_-4px_rgba(0,0,0,0.05)] relative overflow-hidden">
          ...
          <form action="/api/auth/google?next=login" method="get" className="mb-5">
            <button
              type="submit"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 bg-[#F7F7F8] border border-black/[0.08] rounded-xl px-3.5 text-[13.5px] text-[#0A0A0A] placeholder-[#888888] focus:bg-white focus:outline-none focus:border-black/30 focus:ring-2 focus:ring-black/[0.04] transition-all duration-200 truncate"
              />
            </div>
