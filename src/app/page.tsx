      ...
      <div className="relative z-20">
        ...
        <Section className="border-b border-black/[0.05] bg-[#F7F8FA] py-20 sm:py-24 lg:py-[112px]">
          <div className="mx-auto max-w-[1180px] px-6">
            ...
            <motion.figure
              variants={fadeUp}
              className="relative mx-auto w-full max-w-[1060px] overflow-hidden rounded-[18px] border border-[#C9D0D9] bg-white shadow-[0_28px_80px_rgba(28,39,54,0.18),0_3px_8px_rgba(28,39,54,0.10)] sm:rounded-[22px]"
            >
              <div className="bg-white">
                ...
                <Image
                  src="/buyerwatch-dashboard-showcase-v6.png"
