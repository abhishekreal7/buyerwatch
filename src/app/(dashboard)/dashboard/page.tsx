  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="relative rounded-2xl border border-[#E3E3E0] bg-white px-4 py-2.5 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[12px] font-semibold text-[#4F5865]">Conversations Found</span>
            <div className="flex h-6 w-6 items-center justify-center shrink-0 text-[#0A84FF]">
        ...
        <div className="rounded-2xl border border-[#E3E3E0] bg-white px-4 py-2.5 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[12px] font-semibold text-[#4F5865]">High Intent</span>
            <div className="flex h-6 w-6 items-center justify-center shrink-0 text-emerald-600">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="rounded-2xl border border-[#E3E3E0] bg-white px-4 py-2.5 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <div className="flex h-6 w-6 items-center justify-center shrink-0 text-[#F06A22]">
