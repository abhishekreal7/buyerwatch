  ...
  return (
    <main className="min-h-screen bg-white text-[#0A0A0A]">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20 pt-20 text-center sm:pt-28">
        ...
        <Link href="/signup?plan=starter&billing=monthly" className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#0A0A0A] px-6 py-3.5 text-sm font-semibold text-white hover:bg-[#222]">Start 7-day Starter trial <ArrowRight className="h-4 w-4" /></Link>
      </section>
