...
const faqs = [
  ...
  { q: 'What does the Starter plan include?', a: 'For a limited time, Monthly Starter is $19 for the first month, then $39/month. Annual Starter is billed $372 upfront. Both include 5 keyword rules, up to 250 conversations per month, and guarded auto-send after the required trust checks.' },
